	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//service메소드는 doPost와 doGet을 모두 처리합니다.
		    ...
		    try {
		      ...
		      if("/clientView/auth/checkEmail.do".equals(servletPath)){
		       ...
		       } else if ("/clientView/auth/memberAdd.do".equals(servletPath)) {
		             if(request.getParameter("email")!=null){
		        ...
		        } else if("/clientView/auth/memberLogIn.do".equals(servletPath)){
		               if(request.getParameter("email")!=null){
		        ...
		        } else if("/clientView/auth/memberDetail.do".equals(servletPath)){
		               if(session.getAttribute("member")!=null){
		                  MemberDto member = (MemberDto)session.getAttribute("member");
		                  model.put("email", member.getEmail()); 
		               }
		               
		        } else if("/clientView/auth/memberUpdate.do".equals(servletPath)){
		            ...
		            } else if("/clientView/auth/findEmail.do".equals(servletPath)){
		            ...
		            } else if("/clientView/auth/findPw.do".equals(servletPath)){
		               if(request.getParameter("email")!=null) {
		      ...
		      } else if("/clientView/search/search.do".equals(servletPath)){
