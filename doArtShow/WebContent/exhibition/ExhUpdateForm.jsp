...
realFolder = "http://localhost:8089/doArtShow/imageFile";
        ...
        <form action="update.do" method="post" enctype="multipart/form-data" name="exhUpdateform">   
			...
			<table class="table nanum table-hover" >
                ...
                <tr>
                    <th>신청과정</th>
                    <td>
                    	<select id="exhGubun1" name="exhGubun1" style="width:100%; padding: .8em .5em;" required>
                ...
                <tr>
                    ...
                    <td>          
                        <select name="exhGubun2" style="width:100%; padding: .8em .5em;" required>
                ...
                <tr>
                    ...
                    <td><textarea name="artistInfo" id="#" rows="20" cols="100" style="width:100%; height:250px;"><%=exhibition.getArtistInfo() %></textarea></td></td>
                </tr>
                <tr>
                ...
                <tr>
                        <th>*전시관 주소</th>
                        <td>
               			<input type="text" id="ExhPlaceAddr1" name="ExhPlaceAddr1" value="${exhibition.exhPlaceAddr1}" style="width:90%;"> 
                ...
                <tr>
                    ...
                    <td>          
                        <select name="exhGubun4" style="width:100%;">
                ...
                <tr>
                	<th>*전시일정</th>
                	<td>
                		<input type="date" name="exhStartDate" value=${exhibition.exhStartDate } style="width:30%;">부터 
                		<input type="date" name="exhEndDate" value=${exhibition.exhStartDate } style="width:30%;">까지
                	</td>
                </tr>
                <tr>
                ...
                <tr>
					...
					<td class="td_right">
                        ...
                        <img src="<%=realFolder%>\<%=exhibition.getImageFile1()%>" border="0" width="150" height="200">
					</td>
				</tr>                              
               	<tr> 
					...
					<td class="td_right">
						...
						<img src="<%=realFolder%>\<%=exhibition.getImageFile2()%>"
