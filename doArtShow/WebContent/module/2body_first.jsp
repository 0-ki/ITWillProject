    ...
    <nav class="navbar navbar-default navbar-fixed-top my-nav-top">
        <div class="container" id="top-container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" id="top-mainlogo-a" href="#page-top"><img src="/doArtShow/images/mainlogo1.png" id="top-mainlogo-img" alt="전시:해"></a>
            </div>
                    ...
                    <div id="login-wrap">
                        ...
                        <form>
                            ...
                            <div id="login-btngroup">
                                <input type="submit" class="btn btn-info" id="submitBtn1" value="로그인" onclick="validateLogin(this.form)">
                                <br>
                            ...
                            <br>
                            <input  type="button"  class="btn btn-danger" id="submitBtn2" value="회원가입" onclick="validateLogin(this.form)">
                            </div>
