    	...
    	<table align="center">
	            ...
	            <tr>
	                ...
	                <td>
	                    ...
	                    <input class="form-check-input" type="radio" name="gender" id="female" checked="checked" value="여성"><label>여</label>
                    </td>
	            </tr>
	            <tr class="check_tr">
                ...
                <tr class="check_tr">
	                <td colspan="3"><div id="checkbox_check"></div></td>
	            </tr>
	            <tr>
	                <td colspan="3">
	                    <input class="btn" type="button" value="회원가입" id="submitBtn" onclick="javascript:validateSignUp(this.form)">
	                </td>
	            </tr>
		</table>
	</form>
