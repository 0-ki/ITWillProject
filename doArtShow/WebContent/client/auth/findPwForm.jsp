...
<form method="post" name="findPwForm">
        <table align="center">
            ...
            <tr>
                ...
                <td><input class="form-control" type="text" name="email" id="input_email"
                placeholder="이메일"></td>
            </tr>
            <tr>
            	<td></td>
                <td class="check_tr"><div id="chkEmail"></div></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td></td>
                <td class="check_tr"><div id="chkBirth"></div></td>
            </tr>
            <tr>
                <td><input class="btn" type="button" id="findPwBtn" value="인증번호 보내기" onclick="chkFindPwForm(this.form)"></td>
            </tr>
        </table>
    </form>
</div>
