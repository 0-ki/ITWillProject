...
<div class="container" id="mainContainer">
  <div class="row">
    ...
    <div class="col-sm-12 col-md-8" id="mainBox">
      ...
      <a href="<%=request.getContextPath()%>/client/auth/wishList.do" class="seeAll" style="color: skyblue;">전체보기</a></p>
      <c:choose>
      ...
      <a href="<%=request.getContextPath()%>/client/exhibition/myList.do" class="seeAll" style="color: skyblue;">전체보기</a></p>
